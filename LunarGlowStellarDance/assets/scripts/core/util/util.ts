import { _decorator, Node, Vec3, Vec2, Color, MeshRenderer, randomRangeInt, tween, Tween, v3, director, Sprite, Component, geometry, GeometryRenderer, IVec3, Quat, IVec3Like, PhysicsSystem, Mat4, quat, renderer, Vec4, Camera } from 'cc';
...
export namespace Gizmo {
    ...
    export function getGeometryRender(): GeometryRenderer | null | undefined {
        ...
        if (EDITOR_NOT_IN_PREVIEW)
            camera = globalThis.cce?.Camera._camera.camera as renderer.scene.Camera;
        else {
            camera = gizmoCamera;
