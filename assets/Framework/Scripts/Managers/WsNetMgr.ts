...
export class WsNetMgr extends Component {
    ...
    public ConnectToServer(url: string = null): void {
        ...
        EventMgr.Instance.Emit(WsNetMgr.WSConnectingEvent, this.url);
    ...
    private CloseSocket(): void {
        if (this.state === State.Connected) {
            ...
            EventMgr.Instance.Emit(WsNetMgr.WSDisconnectEvent, this.url);
        }
    ...
    private OnWebSocketOpened(): void {
        ...
        EventMgr.Instance.Emit(WsNetMgr.WSConnectedEvent, this.url);
    }
    ...
    private OnRecvDataCmd(event: any): void {
        ...
        // Debug.Log(cmdBody);
        EventMgr.Instance.Emit(WsNetMgr.WSRecvDataEvent, cmdBody);
    }
